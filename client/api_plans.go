...
/*
PlansApiService Create a new plan.
...
func (a *PlansApiService) CreatePlan(ctx context.Context, body PlanCreate, code string) (IdResponse, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/plan/{code}"
...
func (a *PlansApiService) DeletePlan(ctx context.Context, code string, id int32) (IdResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/plan/{code}/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"code"+"}", fmt.Sprintf("%v", code), -1)
...
/*
PlansApiService Get a specific plan.
...
/*
PlansApiService Get all plans.
This method allows to retrieve all plans stored in selected project.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param code Code of project, where to search entities.
 * @param optional nil or *PlansApiGetPlansOpts - Optional Parameters:
