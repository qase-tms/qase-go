...
/*
RunsApiService Complete a specific run.
...
func (a *RunsApiService) CompleteRun(ctx context.Context, code string, id int32) (Response, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/run/{code}/{id}/complete"
...
/*
RunsApiService Create a new run.
...
func (a *RunsApiService) CreateRun(ctx context.Context, body RunCreate, code string) (IdResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/run/{code}"
	localVarPath = strings.Replace(localVarPath, "{"+"code"+"}", fmt.Sprintf("%v", code), -1)
...
func (a *RunsApiService) DeleteRun(ctx context.Context, code string, id int32) (IdResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/run/{code}/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"code"+"}", fmt.Sprintf("%v", code), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
RunsApiService Get a specific run.
...
/*
RunsApiService Get all runs.
This method allows to retrieve all runs stored in selected project.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param code Code of project, where to search entities.
 * @param optional nil or *RunsApiGetRunsOpts - Optional Parameters:
     ...
     * @param "Include" (optional.Interface of []string) -  Add this param to include a list of test cases into response. Possible value: cases
     * @param "FiltersStatus" (optional.String) -
     * @param "FiltersMilestone" (optional.Int32) -
     * @param "FiltersEnvironment" (optional.Int32) -
...
func (a *RunsApiService) GetRuns(ctx context.Context, code string, localVarOptionals *RunsApiGetRunsOpts) (RunListResponse, *http.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.FiltersMilestone.IsSet() {
		localVarQueryParams.Add("filters[milestone]", parameterToString(localVarOptionals.FiltersMilestone.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.FiltersEnvironment.IsSet() {
		localVarQueryParams.Add("filters[environment]", parameterToString(localVarOptionals.FiltersEnvironment.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
/*
RunsApiService Update publicity of a specific run.
...
func (a *RunsApiService) UpdateRunPublicity(ctx context.Context, body RunPublic, code string, id int32) (RunPublicResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/run/{code}/{id}/public"
	localVarPath = strings.Replace(localVarPath, "{"+"code"+"}", fmt.Sprintf("%v", code), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
