...
/*
DefectsApiService Create a new defect.
...
func (a *DefectsApiService) CreateDefect(ctx context.Context, body DefectCreate, code string) (IdResponse, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/defect/{code}"
...
/*
DefectsApiService Delete defect.
...
func (a *DefectsApiService) DeleteDefect(ctx context.Context, code string, id int32) (IdResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/defect/{code}/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"code"+"}", fmt.Sprintf("%v", code), -1)
...
/*
DefectsApiService Get a specific defect.
...
/*
DefectsApiService Get all defects.
This method allows to retrieve all defects stored in selected project.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param code Code of project, where to search entities.
 * @param optional nil or *DefectsApiGetDefectsOpts - Optional Parameters:
...
/*
DefectsApiService Resolve a specific defect.
...
func (a *DefectsApiService) ResolveDefect(ctx context.Context, code string, id int32) (IdResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/defect/{code}/resolve/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"code"+"}", fmt.Sprintf("%v", code), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
DefectsApiService Update defect.
...
/*
DefectsApiService Update a specific defect status.
...
func (a *DefectsApiService) UpdateDefectStatus(ctx context.Context, body DefectStatus, code string, id int32) (Response, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/defect/{code}/status/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"code"+"}", fmt.Sprintf("%v", code), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
