...
func (a *EnvironmentsApiService) CreateEnvironment(ctx context.Context, body EnvironmentCreate, code string) (IdResponse, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/environment/{code}"
...
func (a *EnvironmentsApiService) DeleteEnvironment(ctx context.Context, code string, id int32) (IdResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/environment/{code}/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"code"+"}", fmt.Sprintf("%v", code), -1)
...
*/
func (a *EnvironmentsApiService) GetEnvironment(ctx context.Context, code string, id int32) (EnvironmentResponse, *http.Response, error) {
	var (
...
func (a *EnvironmentsApiService) GetEnvironments(ctx context.Context, code string, localVarOptionals *EnvironmentsApiGetEnvironmentsOpts) (EnvironmentListResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
