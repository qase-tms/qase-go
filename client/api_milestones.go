...
/*
MilestonesApiService Create a new milestone.
...
func (a *MilestonesApiService) CreateMilestone(ctx context.Context, body MilestoneCreate, code string) (IdResponse, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/milestone/{code}"
...
/*
MilestonesApiService Delete milestone.
...
func (a *MilestonesApiService) DeleteMilestone(ctx context.Context, code string, id int32) (IdResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/milestone/{code}/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"code"+"}", fmt.Sprintf("%v", code), -1)
...
/*
MilestonesApiService Get a specific milestone.
...
/*
MilestonesApiService Get all milestones.
This method allows to retrieve all milestones stored in selected project.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param code Code of project, where to search entities.
 * @param optional nil or *MilestonesApiGetMilestonesOpts - Optional Parameters:
...
func (a *MilestonesApiService) GetMilestones(ctx context.Context, code string, localVarOptionals *MilestonesApiGetMilestonesOpts) (MilestoneListResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
MilestonesApiService Update milestone.
