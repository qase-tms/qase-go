...
*/
func (a *ProjectsApiService) CreateProject(ctx context.Context, body ProjectCreate) (ProjectCodeResponse, *http.Response, error) {
	var (
...
/*
ProjectsApiService Delete Project by code.
...
func (a *ProjectsApiService) DeleteProject(ctx context.Context, code string) (Response, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/project/{code}"
...
/*
ProjectsApiService Get Project by code.
This method allows to retrieve a specific project.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param code Code of project, where to search entities.
@return ProjectResponse
*/
func (a *ProjectsApiService) GetProject(ctx context.Context, code string) (ProjectResponse, *http.Response, error) {
	var (
...
func (a *ProjectsApiService) GetProjects(ctx context.Context, localVarOptionals *ProjectsApiGetProjectsOpts) (ProjectListResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
ProjectsApiService Grant access to project by code.
...
func (a *ProjectsApiService) GrantAccessToProject(ctx context.Context, body ProjectAccess, code string) (Response, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/project/{code}/access"
	localVarPath = strings.Replace(localVarPath, "{"+"code"+"}", fmt.Sprintf("%v", code), -1)
...
/*
ProjectsApiService Revoke access to project by code.
