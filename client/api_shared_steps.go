...
/*
SharedStepsApiService Create a new shared step.
...
func (a *SharedStepsApiService) CreateSharedStep(ctx context.Context, body SharedStepCreate, code string) (HashResponse, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/shared_step/{code}"
...
/*
SharedStepsApiService Delete shared step.
...
func (a *SharedStepsApiService) DeleteSharedStep(ctx context.Context, code string, hash string) (HashResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/shared_step/{code}/{hash}"
	localVarPath = strings.Replace(localVarPath, "{"+"code"+"}", fmt.Sprintf("%v", code), -1)
...
/*
SharedStepsApiService Get a specific shared step.
...
/*
SharedStepsApiService Get all shared steps.
This method allows to retrieve all shared steps stored in selected project.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param code Code of project, where to search entities.
 * @param optional nil or *SharedStepsApiGetSharedStepsOpts - Optional Parameters:
...
func (a *SharedStepsApiService) GetSharedSteps(ctx context.Context, code string, localVarOptionals *SharedStepsApiGetSharedStepsOpts) (SharedStepListResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
SharedStepsApiService Update shared step.
