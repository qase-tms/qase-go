...
func TestLoadFromEnvironment(t *testing.T) {
	...
	os.Setenv(QaseModeEnvVar, "testops")
	os.Setenv(QaseDebugEnvVar, "true")
	os.Setenv(QaseEnvironmentEnvVar, "staging")
	os.Setenv(QaseCaptureLogsEnvVar, "true")
	os.Setenv(QaseReportDriverEnvVar, "local")
	os.Setenv(QaseReportConnectionPathEnvVar, "/custom/path")
	os.Setenv(QaseReportConnectionFormatEnvVar, "yaml")
	os.Setenv(QaseTestOpsAPITokenEnvVar, "test-token")
	os.Setenv(QaseTestOpsAPIHostEnvVar, "custom.qase.io")
	os.Setenv(QaseTestOpsProjectEnvVar, "TEST")
	os.Setenv(QaseTestOpsRunIDEnvVar, "123")
	os.Setenv(QaseTestOpsDefectEnvVar, "true")
	os.Setenv(QaseTestOpsBatchSizeEnvVar, "50")
	os.Setenv(QaseTestOpsStatusFilterEnvVar, "passed,failed")

	defer func() {
		// Clean up environment variables
		os.Unsetenv(QaseModeEnvVar)
		os.Unsetenv(QaseDebugEnvVar)
		os.Unsetenv(QaseEnvironmentEnvVar)
		os.Unsetenv(QaseCaptureLogsEnvVar)
		os.Unsetenv(QaseReportDriverEnvVar)
		os.Unsetenv(QaseReportConnectionPathEnvVar)
		os.Unsetenv(QaseReportConnectionFormatEnvVar)
		os.Unsetenv(QaseTestOpsAPITokenEnvVar)
		os.Unsetenv(QaseTestOpsAPIHostEnvVar)
		os.Unsetenv(QaseTestOpsProjectEnvVar)
		os.Unsetenv(QaseTestOpsRunIDEnvVar)
		os.Unsetenv(QaseTestOpsDefectEnvVar)
		os.Unsetenv(QaseTestOpsBatchSizeEnvVar)
		os.Unsetenv(QaseTestOpsStatusFilterEnvVar)
	}()
...
func TestConfigLoader(t *testing.T) {
	...
	os.Setenv(QaseTestOpsAPITokenEnvVar, "env-token")
	defer os.Unsetenv(QaseTestOpsAPITokenEnvVar)
