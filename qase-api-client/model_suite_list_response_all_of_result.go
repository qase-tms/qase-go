...
// checks if the SuiteListResponseAllOfResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SuiteListResponseAllOfResult{}

// SuiteListResponseAllOfResult struct for SuiteListResponseAllOfResult
type SuiteListResponseAllOfResult struct {
...
func NewSuiteListResponseAllOfResult() *SuiteListResponseAllOfResult {
	this := SuiteListResponseAllOfResult{}
	return &this
}
...
// SetEntities gets a reference to the given []Suite and assigns it to the Entities field.
func (o *SuiteListResponseAllOfResult) SetEntities(v []Suite) {
	o.Entities = v
}

func (o SuiteListResponseAllOfResult) MarshalJSON() ([]byte, error) {
...
func (o SuiteListResponseAllOfResult) ToMap() (map[string]interface{}, error) {
...
type NullableSuiteListResponseAllOfResult struct {
	value *SuiteListResponseAllOfResult
	isSet bool
}

func (v NullableSuiteListResponseAllOfResult) Get() *SuiteListResponseAllOfResult {
	return v.value
}

func (v *NullableSuiteListResponseAllOfResult) Set(val *SuiteListResponseAllOfResult) {
	v.value = val
	v.isSet = true
}

func (v NullableSuiteListResponseAllOfResult) IsSet() bool {
	return v.isSet
}

func (v *NullableSuiteListResponseAllOfResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuiteListResponseAllOfResult(val *SuiteListResponseAllOfResult) *NullableSuiteListResponseAllOfResult {
	return &NullableSuiteListResponseAllOfResult{value: val, isSet: true}
}

func (v NullableSuiteListResponseAllOfResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuiteListResponseAllOfResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
