...
// checks if the ReviewProposedCase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReviewProposedCase{}

// ReviewProposedCase The test case state proposed by the review. Only the fields the proposal carries are present.
type ReviewProposedCase struct {
	...
	Steps        []ReviewProposedStep `json:"steps,omitempty"`
...
func (o *ReviewProposedCase) SetDescriptionNil() {
...
func (o *ReviewProposedCase) SetPreconditionsNil() {
...
func (o *ReviewProposedCase) SetPostconditionsNil() {
...
func (o *ReviewProposedCase) SetSeverityNil() {
	o.Severity.Set(nil)
}
...
func (o *ReviewProposedCase) SetPriorityNil() {
	o.Priority.Set(nil)
}
...
func (o *ReviewProposedCase) SetBehaviorNil() {
	o.Behavior.Set(nil)
}
...
func (o *ReviewProposedCase) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o *ReviewProposedCase) SetLayerNil() {
	o.Layer.Set(nil)
}
...
func (o *ReviewProposedCase) SetIsFlakyNil() {
	o.IsFlaky.Set(nil)
}
...
func (o *ReviewProposedCase) SetSuiteIdNil() {
	o.SuiteId.Set(nil)
}
...
func (o *ReviewProposedCase) SetMilestoneIdNil() {
...
func (o *ReviewProposedCase) SetStatusNil() {
	o.Status.Set(nil)
}
...
// SetSteps gets a reference to the given []ReviewProposedStep and assigns it to the Steps field.
...
func (o ReviewProposedCase) MarshalJSON() ([]byte, error) {
...
func (o ReviewProposedCase) ToMap() (map[string]interface{}, error) {
...
type NullableReviewProposedCase struct {
	value *ReviewProposedCase
	isSet bool
}

func (v NullableReviewProposedCase) Get() *ReviewProposedCase {
	return v.value
}

func (v *NullableReviewProposedCase) Set(val *ReviewProposedCase) {
	v.value = val
	v.isSet = true
}

func (v NullableReviewProposedCase) IsSet() bool {
	return v.isSet
}

func (v *NullableReviewProposedCase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReviewProposedCase(val *ReviewProposedCase) *NullableReviewProposedCase {
	return &NullableReviewProposedCase{value: val, isSet: true}
}

func (v NullableReviewProposedCase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReviewProposedCase) UnmarshalJSON(src []byte) error {
	v.isSet = true
