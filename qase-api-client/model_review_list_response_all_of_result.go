...
// checks if the ReviewListResponseAllOfResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReviewListResponseAllOfResult{}

// ReviewListResponseAllOfResult struct for ReviewListResponseAllOfResult
type ReviewListResponseAllOfResult struct {
	Total    *int32   `json:"total,omitempty"`
	Filtered *int32   `json:"filtered,omitempty"`
	Count    *int32   `json:"count,omitempty"`
	Entities []Review `json:"entities,omitempty"`
}
...
func NewReviewListResponseAllOfResult() *ReviewListResponseAllOfResult {
	this := ReviewListResponseAllOfResult{}
	return &this
}
...
// SetEntities gets a reference to the given []Review and assigns it to the Entities field.
func (o *ReviewListResponseAllOfResult) SetEntities(v []Review) {
	o.Entities = v
}

func (o ReviewListResponseAllOfResult) MarshalJSON() ([]byte, error) {
...
func (o ReviewListResponseAllOfResult) ToMap() (map[string]interface{}, error) {
...
type NullableReviewListResponseAllOfResult struct {
	value *ReviewListResponseAllOfResult
	isSet bool
}

func (v NullableReviewListResponseAllOfResult) Get() *ReviewListResponseAllOfResult {
	return v.value
}

func (v *NullableReviewListResponseAllOfResult) Set(val *ReviewListResponseAllOfResult) {
	v.value = val
	v.isSet = true
}

func (v NullableReviewListResponseAllOfResult) IsSet() bool {
	return v.isSet
}

func (v *NullableReviewListResponseAllOfResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReviewListResponseAllOfResult(val *ReviewListResponseAllOfResult) *NullableReviewListResponseAllOfResult {
	return &NullableReviewListResponseAllOfResult{value: val, isSet: true}
}

func (v NullableReviewListResponseAllOfResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReviewListResponseAllOfResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
